    ...
    <>
      ...
      >
        ...
        >
          ...
          <VStack color='gray.600' maxW={{ base: 'lg', lg: '2xl' }} lineHeight='taller'>
            <Text>
              もう一度社会を作りなおすためには、
              まず身近な友だちや仲間とともに生きる意識をもつことが重要です。
            </Text>
            <Text>
              グローバルに広がるマーケットから 分離されたローカルな輪を重層的に作っていく。
          ...
          <Box
            ...
            overflow='hidden'
          >
            <NextImage src='/kamogawa.jpg' width='1280px' height='854px' objectFit='cover' />
          </Box>
        </VStack>
      </Flex>
      <Center mt={4} flexDirection='column'>
        <Heading as='h2' fontWeight={500} color='gray.700' fontSize='lg' fontFamily='heading'>
          鴨川デジタル相談所がやっていること
        </Heading>
        <Spacer height={2} />
      ...
      <Spacer height={24} />
      <VStack w='full' justify='center' alignItems='center' fontFamily='body' spacing={4}>
        <Avatar size='2xl' src='/avator-640.jpeg' name='Takuya Kometani' />
        <Heading fontSize='3xl' color='gray.700' fontFamily='heading'>
          こめたに・たくや
        </Heading>
        <Link href='https://instagram.com/t_komenzar' fontWeight={600} color={mainColor} isExternal>
          @t_komenzar (instagram) <ExternalLinkIcon mx={2} />{' '}
        </Link>
        <Link href='mailto:kamo.digi@icloud.com' fontWeight={600} color={mainColor}>
        ...
        <VStack spacing={3} lineHeight='taller'>
          ...
          <Text color='gray.600' maxW={{ base: 'xs', md: 'sm', lg: 'md' }}>
            物を見つけたり、捨てられたものを活用する能力が高い。ヒンディー語でいうजुगाड़ (jugaad)
            の精神に富んでいる。
          </Text>
          <Text color='gray.600' maxW={{ base: 'xs', md: 'sm', lg: 'md' }}>
          ...
          <Box
            ...
            overflow='hidden'
          >
            <NextImage src='/my-katsuo.jpeg' alt='チクリ・カツオ' width='640px' height='480px' />
          </Box>
        </VStack>
      </VStack>
      <Spacer height={24} />
      <Box as='footer'>
        ...
        >
          ...
          <Text>© {year} Kamogawa Digital Consultation. All rights reserved</Text>
        </Container>
      </Box>
    </>
  )
