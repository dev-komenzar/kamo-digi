...
import { Box, chakra, Heading, Link, List, ListIcon, ListItem, Stack, Text } from '@chakra-ui/react'
    ...
    <>
      <Link href='https://www.samgha.org' isExternal>
        <Box
          ...
          pos='relative'
        >
          <ExternalLinkIcon pos='absolute' bottom={2} right={2} boxSize={8} color='white' />
        </Box>
      </Link>
      <Stack p={{ base: 2, md: 4 }}>
...
const trans = (r: number, s: number) =>
  `perspective(1000px) rotateX(8deg) rotateY(${r / 10}deg) rotateZ(${r}deg) scale(${s})`
